...
from model import panoHDR

parser = argparse.ArgumentParser(description='')
parser.add_argument('--phase', dest='phase', default='train', help='train, test')
parser.add_argument('--checkpoint_dir', dest='checkpoint_dir', default='./checkpoint', help='models are saved here')
parser.add_argument('--gpu', dest='gpu', default='0', help='GPU id to use')
...
parser.add_argument('--test_width', dest='test_width', type=int, default=1024, help='scale test images to this width')
parser.add_argument('--test_height', dest='test_height', type=int, default=512, help='scale test images to this height')
...
parser.add_argument('--fine_turn', dest='fine_turn', type=bool, default=False,
                    help='if fine_turn, load the latest model: 1: true, 0: false')
